        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 to-blue-900 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="p-8 bg-blue-700 text-center flex flex-col items-center">
                    <img src="/logo.png" alt="TTHP Home" className="w-20 h-20 mb-4 object-contain bg-white rounded-xl p-2 shadow-lg" />
                    <h1 className="text-3xl font-bold text-white tracking-tight">TTHP Home</h1>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <input 
                                    ...
                                    placeholder="thanhvien@tthp.com"
                                    required
                                />
